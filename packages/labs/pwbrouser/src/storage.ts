...
export async function browser_cookie_set(
  ...
  if (value === undefined || value === null)
    throw new Error('browser_cookie_set requires "value" parameter');
  ...
  return {
    ...
    async get(
      ...
      if (key === undefined || key === null)
        throw new Error('storage get requires a key parameter');
    ...
    async set(
      ...
      const value = params.value as string;
      if (key === undefined || key === null)
        throw new Error('storage set requires a key parameter');
      if (value === undefined || value === null)
        throw new Error('storage set requires a value parameter');
    ...
    async delete(
      ...
      const key = params.key as string;
      if (key === undefined || key === null)
        throw new Error('storage delete requires a key parameter');
...
export async function browser_sessionstorage_list(
  ctx: StorageContext,
...
export async function browser_sessionstorage_clear(
  ctx: StorageContext,
  _p: Record<string, unknown>,
) {
